	...
	<div id="content">
        <div id="steps">
             <form id="formElem" method="post">
                <fieldset class="step">
                    <p class="legend"><!--img src="<?php echo $PARAM['logo'];?>" width="50"-->Informasi Data Guru</p>
                    <p>
                    ...
                    <p class="button">
                        <button id="registerButton" type="submit" name="fiyo_login" class="submit flogin" style="">Login</button>
